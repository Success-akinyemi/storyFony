...
export async function login (req, res, next){
    ...
    try {
        ...
        res.cookie('fonyAccessToken', authToken, { expires: expiryDate, sameSite: 'None', secure: true, path: '/', domain: process.env.CLIENT_URL }).status(201).json({ success: true, data: userData })
    } catch (error) {
